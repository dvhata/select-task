  ...
  return (
    ...
    >
      <div>
        ...
        <span style={{marginLeft: "5px",fontWeight: "bold" }}>You are in:</span>
      ...
      <div style={{marginTop:"10px"}}>
        ...
        <span style={{marginLeft:"5px",fontWeight:"bold"}}>Pick your selection</span>
        {mode ? (
          <div>
            <DropdownComponent
              isMulti={mode}
            ...
            />
            <div>
            {/* <span className="result-selection">Your selection: </span>
              {listSelect.map((choices) => {
                return <span key={choices.id} className="result-selection">"{choices?.name}",</span>;
              })} */}
            </div>
          </div>
        ) : (
          <div>
            ...
            />
            {/* <span className="result-selection">Your selection: "{option.name}"</span> */}
          </div>
        )}
      </div>
    </div>
